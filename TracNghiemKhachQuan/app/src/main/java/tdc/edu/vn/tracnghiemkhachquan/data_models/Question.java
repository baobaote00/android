...
public class Question {
    ...
    public static void init(){
        ...
        question1.setQuestionChoices("Peer - to – Peer" , "Remote Access" , "Terminal Mainframe" , "Client – Server","Gửi thư điện tử");
        ...
        question2.setQuestionChoice("Cấp địa chỉ cho các máy trạm","Phân giải tên miền và địa chỉ IP","Truyền file và dữ liệu","Gửi thư điện tử","Gửi thư điện tử");
        ...
        question3.setQuestionChoiceA("Giao thức DHCP có thể cấp được...","Mô hình mạng dùng nhiều nhất...","Dịch vụ DNS dùng để ...","Gửi thư điện tử");
        question3.setQuestionChoiceB("Địa chỉ Mac" , "Địa chỉ IP" , "Subnet Mask" , "Client – Server" , "Phân giải tên và địa chỉ","Gửi thư điện tử");
